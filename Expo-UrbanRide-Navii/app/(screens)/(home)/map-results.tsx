...
// Optionally, import and use useLocationStore if you want to access global location state
  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      <Animated.View entering={FadeInUp.delay(400)} className="bg-white rounded-t-3xl p-4 shadow-lg">
        ...
        {/* Book Button */}
        <TouchableOpacity onPress={handleBookRide} className="bg-blue-600 rounded-2xl p-4 mb-10 items-center" activeOpacity={0.8}>
