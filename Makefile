...
.PHONY: start start-clean ios ios-device android android-device prebuild clean-build rn-start ios-clean android-clean eas-login eas-build-dev eas-build-preview eas-build-prod eas-submit adb-devices ios-list
