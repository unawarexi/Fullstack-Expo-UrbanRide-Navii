...
// Import map services
import { addIconsToLocations, autoCompleteLocation, geocodeLatAndLong, getCurrentLocation, LocationCoordinate } from "@/core/maps/maps-services";
// Import global location store
...
const SearchInputField = () => {
  ...
  const performSearch = async (query: string) => {
    ...
    setIsSearching(true);
    try {
      const results = await autoCompleteLocation(query, userLocationData?.coordinates);
  ...
  return (
    <View className="flex-1 bg-gray-50 font-JakartaMedium">
      {/* Header */}
      <Animated.View entering={FadeInUp.duration(500)} className="bg-white px-4 py-4 pt-10 border-b border-gray-100">
