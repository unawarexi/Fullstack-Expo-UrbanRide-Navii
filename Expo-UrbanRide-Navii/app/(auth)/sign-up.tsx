...
import { useSignUpLogic } from "@/lib/auth";
...
const SignUp = () => {
  const { signUpWithEmail, loading: signUpLoading } = useSignUpLogic();
            ...
            <View className="p-6 pt-8">
              ...
              <View className="mb-3">
                ...
                <Controller
                  ...
                  render={({ field: { onChange, onBlur, value } }) => (
                    <View className="mb-3">
                      <Text className="text-base font-JakartaSemiBold text-gray-800 mb-1">Phone Number</Text>
                      <View className="relative">
                        <View className="absolute left-4 top-1/2 -mt-3 z-10">
                          <LucideIcons.phone size={20} color="#6B7280" />
                        </View>
                        <TextInput
                          className="bg-white border border-gray-200 rounded-2xl pl-12 pr-4 py-4 text-gray-800 font-JakartaMedium text-base focus:border-blue-500 focus:bg-blue-50/30"
